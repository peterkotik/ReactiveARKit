...
//        }.disposed(by: disposeBag)
        ...
        sceneView.willAddNodeForARObjectAnchor.subscribe {
            guard let tuple = $0.element else { return }
            
            print("ARSKView: \(tuple.0)")
            print("ARAnchor: \(tuple.1)")
        }.disposed(by: disposeBag)
        
        sceneView.willAddNodeForARPlaneAnchor.subscribe {
            guard let tuple = $0.element else { return }
        ...
        sceneView.willAddNodeForARImageAnchor.subscribe {
            guard let tuple = $0.element else { return }
        ...
        sceneView.willAddNodeForARFaceAnchor.subscribe {
            guard let tuple = $0.element else { return }
